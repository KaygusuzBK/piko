          ...
          <Card className="border-none bg-transparent shadow-none">
            <CardContent className="p-3 sm:p-4">
              <div className="space-y-3 sm:space-y-4">
                <Button onClick={() => router.push('/')} variant="ghost" className="w-full justify-start text-foreground hover:text-white hover:bg-soc-ai-gradient transition-all duration-200 hover:scale-105">
                ...
                <Button variant="ghost" className="w-full justify-start text-foreground hover:text-white hover:bg-soc-ai-gradient transition-all duration-200 hover:scale-105">
                ...
                <Button onClick={() => router.push('/favorites')} variant="ghost" className="w-full justify-start text-foreground hover:text-white hover:bg-soc-ai-gradient transition-all duration-200 hover:scale-105">
                ...
                <Button onClick={() => user?.id && router.push(`/users/${user.id}`)} variant="ghost" className="w-full justify-start text-foreground hover:text-white hover:bg-soc-ai-gradient transition-all duration-200 hover:scale-105">
